...
public class HienThiTaiKhoanAdapter extends BaseAdapter {
    Context context;
    int layout;
    List<TaiKhoanDTO> dangKyDTOList;
    ViewHolder viewHolder;

    public HienThiTaiKhoanAdapter(Context context, int layout, List<TaiKhoanDTO> dangKyDTOList){
    ...
    public View getView(int i, View view, ViewGroup viewGroup) {
        ...
        TaiKhoanDTO dangKyDTO = dangKyDTOList.get(i);
